...
import (
	...
	"github.com/fertech02/Wasa-repository/service/api"
	"github.com/fertech02/Wasa-repository/service/database"
	"github.com/fertech02/Wasa-repository/service/globaltime"
...
func run() error {
	...
	// Check for the filesystem folder
	directoryPath := "/tmp/filesystem/"
	if _, err := os.Stat(directoryPath); os.IsNotExist(err) {
		// Directory does not exist, create it
		err := os.Mkdir(directoryPath, 0755)
		if err != nil {
			logger.WithError(err).Error("error creating directory")
